...
class NavRailMixin:
    def _create_nav_rail(self):
        ...
        # Batch Text Copy/Paste Buttons
        self.copy_all_button = MToolButton()
        self.copy_all_button.set_dayu_svg("mingcute--copy-2-line.svg")
        self.copy_all_button.setToolTip(self.tr("Copy all text (Gemini format)"))

        self.paste_all_button = MToolButton()
        self.paste_all_button.set_dayu_svg("mingcute--clipboard-line.svg")
        self.paste_all_button.setToolTip(self.tr("Paste all text (Translated)"))
        ...
        nav_rail_layout.addWidget(self.copy_all_button)
        nav_rail_layout.addWidget(self.paste_all_button)
