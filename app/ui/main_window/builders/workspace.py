...
class WorkspaceMixin:
    def _create_main_content(self):
        ...
        self.compare_toggle = MToolButton()
        self.compare_toggle.set_dayu_svg("compare-toggle.svg")
        self.compare_toggle.huge()
        ...
        # Batch Text Copy/Paste Layout
        batch_io_layout = QtWidgets.QHBoxLayout()
        
        # Current Page Group
        self.workspace_copy_page_button = MToolButton().svg("mingcute--document-line.svg")
        self.workspace_copy_page_button.setToolTip(self.tr("Copy Current Page"))
        self.workspace_copy_page_button.set_dayu_size(dayu_theme.medium)

        self.workspace_paste_page_button = MToolButton().svg("upload-file.svg")
        self.workspace_paste_page_button.setToolTip(self.tr("Paste Current Page"))
        self.workspace_paste_page_button.set_dayu_size(dayu_theme.medium)

        # All Pages Group
        self.workspace_copy_all_button = MToolButton().svg("tabler--file-export.svg")
        self.workspace_copy_all_button.setToolTip(self.tr("Copy ALL Pages"))
        self.workspace_copy_all_button.set_dayu_size(dayu_theme.medium)

        self.workspace_paste_all_button = MToolButton().svg("upload_line.svg")
        self.workspace_paste_all_button.setToolTip(self.tr("Paste ALL Pages"))
        self.workspace_paste_all_button.set_dayu_size(dayu_theme.medium)

        batch_io_layout.addWidget(self.workspace_copy_page_button)
        batch_io_layout.addWidget(self.workspace_paste_page_button)
        batch_io_layout.addSpacing(10)
        batch_io_layout.addWidget(MDivider(orientation=QtCore.Qt.Vertical))
        batch_io_layout.addSpacing(10)
        batch_io_layout.addWidget(self.workspace_copy_all_button)
        batch_io_layout.addWidget(self.workspace_paste_all_button)
        batch_io_layout.addStretch()
        right_layout.addLayout(batch_io_layout)
        ...
        self.workspace_magic_wand_button = MToolButton().svg("pipeline_clean.svg")
        self.workspace_magic_wand_button.setCheckable(True)
        self.workspace_magic_wand_button.setToolTip(self.tr("Magic Wand: Click on a text bubble to clean it manually"))
        self.workspace_magic_wand_button.clicked.connect(self.toggle_magic_wand_tool)
        self.tool_buttons["magic_wand"] = self.workspace_magic_wand_button

        self.workspace_rect_clean_button = MToolButton().svg("select.svg")
        self.workspace_rect_clean_button.setCheckable(True)
        self.workspace_rect_clean_button.setToolTip(self.tr("Rect Clean: Click and drag to fill an area with the starting color"))
        self.workspace_rect_clean_button.clicked.connect(self.toggle_rect_clean_tool)
        self.tool_buttons["rect_clean"] = self.workspace_rect_clean_button

        self.workspace_inpaint_rect_button = MToolButton().svg("edit_line.svg")
        self.workspace_inpaint_rect_button.setCheckable(True)
        self.workspace_inpaint_rect_button.setToolTip(self.tr("Inpaint Rect: Click and drag to clean an area using AI"))
        self.workspace_inpaint_rect_button.clicked.connect(self.toggle_inpaint_rect_tool)
        self.tool_buttons["inpaint_rect"] = self.workspace_inpaint_rect_button

        self.workspace_magic_wand_all_button = MToolButton().svg("pipeline_clean.svg")
        self.workspace_magic_wand_all_button.setToolTip(self.tr("Magic Wand All: Clean ALL text blocks on ALL pages"))
        self.workspace_magic_wand_all_button.set_dayu_size(dayu_theme.medium)
        self.workspace_magic_wand_all_button.setStyleSheet("""
            MToolButton {
        ...
        inp_tools_lay.addWidget(self.workspace_magic_wand_button)
