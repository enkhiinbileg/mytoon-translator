...
class WebtoonLayoutManager:
    ...
    def __init__(self, viewer):
        ...
        self.viewport_buffer = 4  # Load N pages above/below viewport
    ...
    def clone_from(self, other):
        """Clone layout data from another layout manager."""
        self.image_positions = other.image_positions.copy()
        self.image_heights = other.image_heights.copy()
        self.page_bottoms = other.page_bottoms.copy()
        self.total_height = other.total_height
        self.webtoon_width = other.webtoon_width
        self.image_spacing = other.image_spacing
        self._scene.setSceneRect(0, 0, self.webtoon_width, self.total_height)
    ...
    def ensure_current_page_visible(self, image_items: dict):
        ...
        # Skip this if we are in Compare Mode to avoid fighting with CompareView's sync
        if hasattr(self.viewer, 'parent') and self.viewer.parent() and self.viewer.parent().__class__.__name__ == 'CompareView':
            return
