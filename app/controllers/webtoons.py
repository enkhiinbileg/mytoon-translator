...
class LazyLoadingConfig:
    ...
    viewport_buffer: int = 4
    load_timer_interval: int = 10
...
class WebtoonController:
    ...
    def _switch_to_lazy_webtoon_mode(self) -> bool:
        ...
        # Set active undo stack for the current page
        file_path = self.image_files[current_page]
    ...
    def _switch_to_regular_mode_existing(self):
        ...
        # Make sure the image viewer is the current widget if not in compare mode
    ...
    def on_page_changed(self, page_index: int):
        ...
        if (self.image_viewer.webtoon_mode and
            ...
            try:
                # Update the current image index and active undo stack
